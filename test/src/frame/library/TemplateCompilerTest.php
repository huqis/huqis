...
class TemplateCompilerTest extends PHPUnit_Framework_TestCase {
    ...
    public function providerCompile() {
        return array(
            ...
            array('{if $variable.method($argument.method())}Testing{/if}', 'if ($context->ensureObject($context->getVariable(\'variable\', false), \'Could not call method($argument.method()): $variable is not an object\')->method($context->ensureObject($context->getVariable(\'argument\', false), \'Could not call method(): $argument is not an object\')->method())) {echo "Testing";}'),
            array('{if $variable.method($argument.method()) and true}Testing{/if}', 'if ($context->ensureObject($context->getVariable(\'variable\', false), \'Could not call method($argument.method()): $variable is not an object\')->method($context->ensureObject($context->getVariable(\'argument\', false), \'Could not call method(): $argument is not an object\')->method()) and true) {echo "Testing";}'),
            array('{if $variable.method() or (!$variable.property and $otherVariable.method())}Testing{/if}', 'if ($context->ensureObject($context->getVariable(\'variable\', false), \'Could not call method(): $variable is not an object\')->method() or (!$context->getVariable(\'variable.property\') and $context->ensureObject($context->getVariable(\'otherVariable\', false), \'Could not call method(): $otherVariable is not an object\')->method())) {echo "Testing";}'),
            array('{if $variable.method() or (!$variable.property and $otherVariable.method($argument)) or ($variable.property and $otherVariable.method2())}Testing{/if}', 'if ($context->ensureObject($context->getVariable(\'variable\', false), \'Could not call method(): $variable is not an object\')->method() or (!$context->getVariable(\'variable.property\') and $context->ensureObject($context->getVariable(\'otherVariable\', false), \'Could not call method($argument): $otherVariable is not an object\')->method($context->getVariable(\'argument\', false))) or ($context->getVariable(\'variable.property\') and $context->ensureObject($context->getVariable(\'otherVariable\', false), \'Could not call method2(): $otherVariable is not an object\')->method2())) {echo "Testing";}'),
