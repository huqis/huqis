...
use huqis\exception\ReflectionTemplateException;
...
class ReflectionHelper {
     ...
     * @throws \huqis\exception\ReflectionTemplateException
     */
     ...
     * @throws \huqis\exception\ReflectionTemplateException when an
