...
class FileHelper {
     ...
     * @return null
     * @throws \frame\library\exception\TemplateException when the directory or
     ...
     * @return null
     * @throws \frame\library\exception\TemplateException when the file or
     ...
     * @param string $file Path to the file
     * @return null
     * @throws \frame\library\exception\TemplateException when the file could
     * not be deleted
     */
     ...
     * @return null
     * @throws \frame\library\exception\TemplateException when the directory
