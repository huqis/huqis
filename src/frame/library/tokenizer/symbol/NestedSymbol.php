...
use frame\library\exception\TokenizeTemplateException;
use frame\library\tokenizer\Tokenizer;
...
class NestedSymbol extends AbstractSymbol {
     ...
     * @var \frame\library\tokenizer\Tokenizer
     */
    protected $tokenizer;
     ...
     * @param \frame\library\tokenizer\Tokenizer $tokenizer When provided, the
